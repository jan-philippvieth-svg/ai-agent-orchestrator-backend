import type { DeletionRequestResult } from '../types/index.js';
import { PayloadStoreService } from './payloadStore.service.js';
import { QdrantService } from './qdrant.service.js';

export class DeletionRequestService {
  constructor(
    private readonly payloads = new PayloadStoreService(),
    private readonly qdrant = new QdrantService(),
  ) {}

  async deleteSubject(tenantId: string, subjectId: string): Promise<DeletionRequestResult> {
