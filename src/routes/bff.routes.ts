...
async function requireBffSession(
  request: FastifyRequest,
  reply: FastifyReply,
  sessions: BffSessionService,
...
async function requireCsrf(request: FastifyRequest, reply: FastifyReply, session: BffSession): Promise<boolean> {
